...
import { Wrapper, TitleWrapper, StyledTitleText, FormWrapper } from '@/pages/Holder/Auth/LoginHolder.styles';
import { StyledLogoText } from '@/pages/Holder/Auth/LoginHolder.styles'; // 새로운 스타일 컴포넌트를 가져옵니다
